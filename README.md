...
Собираю веб-приложения и небольшие сервисы под конкретную задачу: сайты-визитки и лендинги, приложения внутри Телеграма, ботов и автоматизацию рутины. Веду проект целиком, от макета и вёрстки до домена и публикации.
